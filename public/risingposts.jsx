...
console.log(updatedList);
    ...
    render: function() {
            ...
            <div className="form-group">
				<button for="collapseEight" className="btn btn-default" data-toggle="collapse" href="#collapseEight" aria-expanded="false" aria-controls="collapseEight">SEARCH!</button>
            ...
            <List2 user = {this.state.user} posts = {this.state.items} uid = {this.state.uid} />
            </div>
  ...
  var uids = '/user/' + uid;
    ...
    <ul className = "list-unstyled">
    {
	 ...
	 <div className = "inlinegroup"> 
         <div id = "upvote1" className = "inline"><span  style = {style} id = {"upvote5" + post._id} className = "glyphicon glyphicon-menu-up" 
         onClick =
{function(event){
...
></span></div> <div className ="inline"><span id = {"numbah5" + post._id}>{post.upvotes}</span> </div> <div className = "inline"><span id = {"downvote5" + post._id} style = {style2}className = "glyphicon glyphicon-menu-down" 
onClick =           
{function(event){
