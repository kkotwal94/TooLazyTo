...
console.log(updatedList);
    ...
    render: function() {
            ...
            <div className="form-group">
				<button for="collapseNine" className="btn btn-default" data-toggle="collapse" href="#collapseNine" aria-expanded="false" aria-controls="collapseNine">SEARCH!</button>
            ...
            <List4 user = {this.state.user} posts = {this.state.items} uid = {this.state.uid}/>
            </div>
...
var List4 = React.createClass({ //has to be called list
	...
	var tracker = post.upvotes;
	 ...
	 <div className = "inlinegroup"> 
         <div id = "upvote1" className = "inline"><span  style = {style} id = {"upvote2" + post._id} className = "glyphicon glyphicon-menu-up" 
         onClick =
{function(event){
...
></span></div> <div className ="inline"><span id = {"numbah2" + post._id}>{post.upvotes}</span> </div> <div className = "inline"><span id = {"downvote2" + post._id} style = {style2}className = "glyphicon glyphicon-menu-down" 
onClick =           
{function(event){
...
document.getElementById('nolove'));
