...
var List1 = React.createClass({ //has to be called list
...
></span></div></div><li className ="inlinelist" key = {post._id}> <h4>{post.title}</h4>
         ...
         <p><a href = {'/' + post._id} >{post.allComments} comments</a> Created By: {post.author} on: {new Date(post.date).toUTCString()}</p>
