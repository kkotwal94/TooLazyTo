...
console.log(updatedList);
    ...
    render: function() {
            ...
            <div className="form-group">
				<button for="collapseSix" className="btn btn-default" data-toggle="collapse" href="#collapseSix" aria-expanded="false" aria-controls="collapseSix">SEARCH!</button>
					...
					<label className="input__label input__label--hoshi input__label--hoshi-color-2" for="input-4">
            ...
            <List50 user = {this.state.user} posts = {this.state.items} uid = {this.state.uid} />
            </div>
...
var List50 = React.createClass({ //has to be called list
	...
	var tracker = post.upvotes;
	 ...
	 <div className = "inlinegroup"> 
         <div id = "upvote1" className = "inline"><span  style = {style} id = {"upvote4" + post._id} className = "glyphicon glyphicon-menu-up" 
         onClick =
{function(event){
...
></span></div> <div className ="inline"><span id = {"numbah4" + post._id}>{post.upvotes}</span> </div> <div className = "inline"><span id = {"downvote4" + post._id} style = {style2}className = "glyphicon glyphicon-menu-down" 
onClick =           
{function(event){
